-- INFOTESS SDMS — Clean Re-seed (run AFTER tables already exist)
-- Run in Supabase SQL Editor

-- Wipe data in dependency order
TRUNCATE notifications, message_reads, messages, receipts, payments, students, system_settings, news RESTART IDENTITY CASCADE;

-- ============================================================
-- USERS  (keep existing, add missing)
-- ============================================================
